!function(e, t) {
    ...
    function o(e) {
        ...
        this.matchers = [L.matchByNormalizedQuery(), L.matchByWords()]
    }
    function a(t, n) {
        var i = this;
        i.element = t,
    ...
    var m = {
      ...
      , I = {
        ...
        matchers: [L.matchByNormalizedQuery(R), L.matchByWordsAddress(R)],
        dataComponents: D,
        ...
        composeValue: function(e, t) {
            var n = e.region_with_type || y.compact([e.region, e.region_type]).join(" ") || e.region_type_full
              , i = e.area_with_type || y.compact([e.area_type, e.area]).join(" ") || e.area_type_full
              , s = e.city_with_type || y.compact([e.city_type, e.city]).join(" ") || e.city_type_full
              , o = e.settlement_with_type || y.compact([e.settlement_type, e.settlement]).join(" ") || e.settlement_type_full
              , a = e.city_district_with_type || y.compact([e.city_district_type, e.city_district]).join(" ") || e.city_district_type_full
              , r = e.street_with_type || y.compact([e.street_type, e.street]).join(" ") || e.street_type_full
            ...
            y.compact([n, i, s, a, o, r, l, u, c]).join(", ")
        },
      ...
      , q = {
        urlSuffix: "fio",
        noSuggestionsHint: !1,
        matchers: [L.matchByNormalizedQuery(), L.matchByWords()],
        fieldNames: {
            surname: "фамилия",
            name: "имя",
            patronymic: "отчество"
      ...
      , A = {
        urlSuffix: "email",
        noSuggestionsHint: !1,
        matchers: [L.matchByNormalizedQuery()],
    ...
    var oe = {
      ...
      , ae = ["region_fias_id", "area_fias_id", "city_fias_id", "city_district_fias_id", "settlement_fias_id", "street_fias_id"]
      , re = function(e, t) {
        var n, i, s = this, o = {};
        s.instance = t,
        s.fields = {},
